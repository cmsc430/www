...
(define (vect-bits? v)
  (zero? (bitwise-xor (bitwise-and v ptr-mask) type-vect)))

(define (str-bits? v)
  (zero? (bitwise-xor (bitwise-and v ptr-mask) type-str)))

(define (symb-bits? v)
  (zero? (bitwise-xor (bitwise-and v ptr-mask) type-symb)))
