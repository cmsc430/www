...
\subtitle{CMSC 430}
\date{January 26\textsuperscript{th}, 2021}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
  ...
  \frame{
    \frametitle{Before we start...}
      \begin{enumerate}
        \item<2 - 5> Who am I?
        \item<3 - 5> Who is on the lecture videos?
  ...
  \frame{
    \frametitle{Who am I?}
      \onslide<2>{Leonidas Lampropoulos}\\
      \onslide<2>{PhD in Programming Languages}
  }

  \frame{
    \frametitle{Who am I?}
      {{\bf \large{Leo}}nidas Lampropoulos}\\
      {PhD in Programming Languages}
  }

  
  \frame{
    \frametitle{Who is on the lecture videos?}
      \onslide<2>{Jos$\acute{e}$ Manuel Calder$\acute{o}$n Trilla}\\
      \onslide<2>{PhD in Compilers}\\
      \onslide<2>{Taught CMSC 430 Last Semester}
  }
