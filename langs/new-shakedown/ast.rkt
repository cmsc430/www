...
(define (ccalls p)
  (define (ccalls p)
    (match p
      [(Prog ds e)     (append (append-map ccalls ds) (ccalls e))]
      [(Defn f xs e)   (ccalls e)]
      [(Prim1 p e)     (ccalls e)]
      [(Prim2 p e1 e2) (append (ccalls e1) (ccalls e2))]
      [(If e1 e2 e3)   (append (ccalls e1) (ccalls e2) (ccalls e3))]
      [(Begin e1 e2)   (append (ccalls e1) (ccalls e2))]
      [(Let x e1 e2)   (append (ccalls e1) (ccalls e2))]
      [(LetRec bs e1)  (append (append-map ccalls (append-map lambda-defs bs)) (ccalls e1))]
      [(Lam n xs e1)   (ccalls e1)]
      [(App f es)      (append (ccalls f) (append-map ccalls es))]
      [(CCall f es)    (cons f (append-map ccalls es))]
      [_        '()]))
  (remove-duplicates (ccalls p)))
