...
semantics say about @racket[(Add1 (Bool #f))]? What about
...
@math{v} such that @math{(@racket[(Add1 (Bool #f))], v) ∈ 𝑫}.  This
...
(interp (If (Zero? (Int 7)) (Int 1) (Int 2)))
]
